        ...
        <div className="container ">
            <div className='d-flex my-4'>
                <div className="bg-banner bg-dark text-light px-4 py-4 rounded-3">
                    ...
                    <div className="row mb-4">
                        <div className="col-md-12">
                            ...
                            <p>
                                Data visualization is the representation of data in graphical or visual format. It enables
                                decision-makers to see analytics presented visually, so they can grasp difficult concepts or
                ...
                <div className='mt-4 rounded-circle'>
                    <img src="banner.png" className='img-fluid' alt="image of pie chart and a human hand" />
                </div>
            </div>
            <hr />
            <div className=''>
